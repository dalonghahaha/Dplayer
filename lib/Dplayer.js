...
Dplayer.prototype.change_src = function(src){
    this.pause();
...
Dplayer.prototype.on_control_forward = function(event){
    ...
    if(this.runtime.playing){
        this.change_src(this.runtime.playlist[play_index + 1].src);
    } else {
        this.runtime.video.src = this.runtime.playlist[play_index + 1].src;
